...
--[[					
	...
	-- set loading font
	love.graphics.setNewFont( 'media/fonts/pigpen.ttf', 16 )
--[[
	loader.start( 
		function()
			self:gotoState( nextscene, filepath, levelname, gamemode )
...
function Loading:draw()
	local center = 0
	screenposition_.x = (GetScreenwidth()-backImageSize.w)/2
	screenposition_.y = (GetScreenheight()-backImageSize.h)/2
